...
Config.Zones = {
	...
	VehicleDelivery = {
		Pos   = {x = -360.12,  y = -128.28,  z = 38.68},
		Size  = { x = 20.0, y = 20.0, z = 3.0 },
		Color = { r = 255, g = 25, b = 255 },
		Type  = -1
	}
}
